...
public class MessageBuilder extends TestEnvironment {
    ...
    public void messageStartTest(ITestResult iTestResult) {
        logger.info(StringUtils.repeat("=", 48) + " TESTING DIMULAI " + StringUtils.repeat("=", 48));
    ...
    public void messageSuccessTest() {
        logger.info(StringUtils.repeat("=", 37) + " TESTING SELESAI  WITH " + ANSI_GREEN + "SUCCESS STATUS " + ANSI_RESET + StringUtils.repeat("=", 38));
    }
